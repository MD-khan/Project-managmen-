...
<?php   
    ...
    echo " <tr>															
            <td><span> <a href='phase-admin/id/".$result['project_id']."/project_cat_id/".$result['project_cat_id']."/com_id/".$result['company_id']."'>  ".$result['project_id']." </a> </span></td>
            <td><span> <a href='phase-admin/id/".$result['project_id']."/project_cat_id/".$result['project_cat_id']."/com_id/".$result['company_id']."'>  ".$result['project_name']." </a> </span></td>
           ...
           <td><span> $".$result['project_cost']." </span></td>
