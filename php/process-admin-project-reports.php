...
<thead>
<tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="table-example" rowspan="1" colspan="1" aria-sort="ascending" aria-label=" PROJECT ID : activate to sort column descending" style="width: 86px;"><span> PROJECT ID </span></th><th class="sorting" tabindex="0" aria-controls="table-example" rowspan="1" colspan="1" aria-label=" PROJECT NAME: activate to sort column ascending" style="width: 188px;"><span> PROJECT NAME</span></th><th class="sorting" tabindex="0" aria-controls="table-example" rowspan="1" colspan="1" aria-label=" SERVICES : activate to sort column ascending" style="width: 186px;"><span> SERVICES </span></th><th class="sorting" tabindex="0" aria-controls="table-example" rowspan="1" colspan="1" aria-label=" CLIENTS : activate to sort column ascending" style="width: 133px;"><span> CLIENTS </span></th><th class="sorting" tabindex="0" aria-controls="table-example" rowspan="1" colspan="1" aria-label=" START DATE : activate to sort column ascending" style="width: 122px;"><span> START DATE </span></th><th class="sorting" tabindex="0" aria-controls="table-example" rowspan="1" colspan="1" aria-label=" COST : activate to sort column ascending" style="width: 71px;"><span> COST </span></th><th class="sorting" tabindex="0" aria-controls="table-example" rowspan="1" colspan="1" aria-label=" STATUS : activate to sort column ascending" style="width: 71px;"><span> STATUS </span></th></tr>
</thead>
<tbody>'; 
?>
...
foreach ($open_project_details as $open_project) {
 echo "
        <tr role='row' class='odd'>            
           ...
           <a href='phase-admin/id/".$open_project['project_id']."/project_cat_id/".$open_project['project_cat_id']."/com_id/".$open_project['company_id']."'>  ".$open_project['project_id']."
               </a> </span></td>
            <td><span> 
             <a href='phase-admin/id/".$open_project['project_id']."/project_cat_id/".$open_project['project_cat_id']."/com_id/".$open_project['company_id']."'>  ".$open_project['project_name']."
                </span></td>
...
foreach ($project_details as $closed_project) {
 echo "
        <tr role='row' class='odd'>            
           <td><span>
                 <a href='phase-admin/id/".$closed_project['project_id']."/project_cat_id/".$closed_project['project_cat_id']."/com_id/".$closed_project['company_id']."'>  ".$closed_project['project_id']."
                  
                        </a> 
               </span></td>
            <td><span> 
               <a href='phase-admin/id/".$closed_project['project_id']."/project_cat_id/".$closed_project['project_cat_id']."/com_id/".$closed_project['company_id']."'>  ".$closed_project['project_name']." </a>
                    </span></td>
           ...
           <td><span> $".$closed_project['project_cost']." </span></td>"
...
foreach ($project_details as $closed_project) {
 echo "
        <tr role='row' class='odd'>            
           <td><span> <a href='phase-admin/id/".$closed_project['project_id']."/project_cat_id/".$closed_project['project_cat_id']."/com_id/".$closed_project['company_id']."'>  ".$closed_project['project_id']." </a> </span></td>
            <td><span><a href='phase-admin/id/".$closed_project['project_id']."/project_cat_id/".$closed_project['project_cat_id']."/com_id/".$closed_project['company_id']."'>  ".$closed_project['project_name']." </a> </span></td>
            <td><span> ".$closed_project['project_category']." </span></td>
            <td><span> ".$closed_project['company_name']." </span></td>
           <td><span> ".date('M j, Y', strtotime($closed_project['project_start_date']))." </span></td>
           <td><span> $".$closed_project['project_cost']." </span></td>"
...
foreach ($project_details as $closed_project) {
 echo "
        <tr role='row' class='odd'>            
           <td><span> <a href='phase-admin/id/".$closed_project['project_id']."'>  ".$closed_project['project_id']." </a> </span></td>
            <td><span> <a href='phase-admin/id/".$closed_project['project_id']."/project_cat_id/".$closed_project['project_cat_id']."/com_id/".$closed_project['company_id']."'>  ".$closed_project['name']." </a> </span></td>
            <td><span> ".$closed_project['project_category']." </span></td>
            <td><span> ".$closed_project['company_name']." </span></td>
           <td><span> ".date('M j, Y', strtotime($closed_project['project_start_date']))." </span></td>
           <td><span> $".$closed_project['project_cost']." </span></td>"
